# Homework 3: : Конфигурирование и запуск проекта dbt

В рамках ДЗ вы попрактикуетесь в развертывании Clickhouse, 
запуске проекта dbt и работе с github actions.

**Требования:**
- Модель витрины в dbt проекте доработана, хранилище строится успешно.

**Результат:**
- Ссылка на PR в gihub с "зеленым" пайплайном
